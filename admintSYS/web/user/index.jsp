			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="/manageController/exit">退出</a></li>
				</ul>
			</li>
...
$(function () {
	...
	jQuery.ajax({
		url:"/manageController/selectRoleName",
		type:"post",
		cache:false,
		dataType: "json",
	...
	$.post("/manageController/selectPowerById",function(data){
		layui.use(['tree', 'util','jquery'], function() {
			...
			tree.render({
				...
				,click: function(obj){
					...
					//picture_add(data.title,data.permitUrl);
					//$("iframe").attr("src",data.permitUrl);
				}
			});
